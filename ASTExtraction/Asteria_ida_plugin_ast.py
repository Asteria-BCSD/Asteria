...
class CHtmlViewer(PluginForm):
    ...
    def AssembleHtml(self, jsondata):
        ...
        _html_template = """
                              ...
                              <body>
                              <table class="diff_tab"  cellspacing="1px">
                              %(rows)s
                              </table>
                              </body>
                              </html>
...
class MyForm(Form):
    ...
    def db_generate(self, code=0):
        ...
        idaapi.msg("[Asteria] >>> AST Extraction finished.\n")
    ...
    def sim_cal(self, code=0):
        ...
        if os.path.exists(self._sqlitefilepath):
            ...
            idaapi.msg("The sqlite file to be calculated is {}".format(sqlite_database2))
            ...
            mainapp_path = os.path.join(idadir, "ASTExtraction", "main_app.py")
            result_path = self._sqlitefilepath.split(".")[0] + ".json"
            cmd = 'python "{}" --use_ast A --result "{}" "{}" "{}"'.format(mainapp_path, result_path, sqlite_database2,
